...
public class HashMap<K, V> implements Iterable<HashMap.Entity> {
    ...
    class HashMapIterator implements Iterator<HashMap.Entity> {
        ...
        public HashMapIterator() {
            while (currentBucketIndex < buckets.length
                    && (buckets[currentBucketIndex] == null || buckets[currentBucketIndex].head == null)) {
                currentBucketIndex++;
            }
        ...
        public Entity next() {
            ...
            while (currentNode == null && ++currentBucketIndex < buckets.length) {
    ...
    public static void main(String[] args) {
        ...
        String res;
        res = hashMap.put("+79005554431", "Andrey");
        res = hashMap.put("+79005554432", "Alex");
        res = hashMap.put("+79005554433", "Darina");
        res = hashMap.put("+79005554434", "Boris");
